...
# This allows declaration	use Net::OrkutSpider ':all';
...
Net::OrkutSpider - Perl extension for spidering the orkut community
...
=head1 DESCRIPTION
        ...
        Net::OrkutSpider uses WWW:Mechanize to scrape orkut.com.
